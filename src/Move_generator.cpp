...
namespace
{
	...
	const void pawn_legal_moves(fixed_vector_t& legal_moves, const Bitboard& pawns_bb, const Bitboard& occupied_squares, const Side& active_player, const Bitboard& current_side_occupied_squares, const std::optional<Position>& en_passant_target_square, const Position& king_square = Position{-1, -1}, const Bitboard& pinned_pieces = {}, const std::function<bool(const Move&)>& satisfies_check_requirements = [](const Move&){ return true; })
	{
		...
		single_moves.for_each_piece([&legal_moves, &occupied_squares, &promotion_rank, &pinned_pieces, &pawn_direction, &king_square, &satisfies_check_requirements, &add_promotion_legal_move, &single_moves](const Position& destination_square)
		{
		...
		right_captures.for_each_piece([&add_promotion_legal_move, &legal_moves, &pinned_pieces, &king_square, &occupied_squares, &pawn_direction, &current_side_occupied_squares, &is_white, &satisfies_check_requirements, &promotion_rank, &en_passant_target_square](const Position& destination_square)
		{
		...
		left_captures.for_each_piece([&legal_moves, &pinned_pieces, &promotion_rank, &occupied_squares, &pawn_direction, &add_promotion_legal_move, &is_white, &current_side_occupied_squares, &en_passant_target_square, &king_square, &satisfies_check_requirements](const Position& destination_square)
		{
			const bool can_capture = !is_free(destination_square, occupied_squares & ~current_side_occupied_squares) || destination_square == en_passant_target_square;
			const Position origin_square = Position{destination_square.rank_-pawn_direction, destination_square.file_+1};
	...
	const void knight_legal_moves(fixed_vector_t& legal_moves, const Bitboard& knight_bb, const Bitboard& our_occupied_squares, const std::function<bool(const Move&)>& satisfies_check_requirements = [](const Move&){ return true; })
	{
	...
	const void king_legal_moves(fixed_vector_t& legal_moves, const Position& original_square, const Bitboard& occupied_squares, const Bitboard& our_occupied_squares, const bool is_white, const Castling_rights_map<bool>& castling_rights, const Bitboard& enemy_attack_map)
	{
	...
	const void rook_legal_moves(fixed_vector_t& legal_moves, const Bitboard& rook_bb, const Bitboard& occupied_squares, const Bitboard& current_sides_occupied_squares, const Position& king_square, const Bitboard& pinned_pieces = {}, const std::function<bool(const Move&)>& satisfies_check_requirements = [](const Move&){ return true; })
	{
		rook_bb.for_each_piece([&king_square, &legal_moves, &current_sides_occupied_squares, occupied_squares, &pinned_pieces, &satisfies_check_requirements](const Position& original_square)
		{
			(rook_legal_moves_bb(original_square, occupied_squares) & ~current_sides_occupied_squares).for_each_piece([&king_square, &legal_moves, &original_square, &pinned_pieces, &satisfies_check_requirements](const auto& destination_square)
			{
	...
	const void bishop_legal_moves(fixed_vector_t& legal_moves, const Bitboard& bishop_bb, const Bitboard& occupied_squares, const Bitboard& current_sides_occupied_squares, const Position& king_square, const Bitboard& pinned_pieces = {}, const std::function<bool(const Move&)>& satisfies_check_requirements = [](const Move&){ return true; })
	{
		bishop_bb.for_each_piece([&king_square, &legal_moves, &current_sides_occupied_squares, occupied_squares, &pinned_pieces, &satisfies_check_requirements](const Position& original_square)
		{
			(bishop_legal_moves_bb(original_square, occupied_squares) & ~current_sides_occupied_squares).for_each_piece([&king_square, &legal_moves, &original_square, &pinned_pieces, &satisfies_check_requirements](const auto& destination_square)
			{
	...
	const void queen_legal_moves(fixed_vector_t& legal_moves, const Bitboard& queen_bb, const Bitboard& occupied_squares, const Bitboard& current_sides_occupied_squares, const Position& king_square, const Bitboard& pinned_pieces = {}, const std::function<bool(const Move&)>& satisfies_check_requirements = [](const Move&){ return true; })
	{
		bishop_legal_moves(legal_moves, queen_bb, occupied_squares, current_sides_occupied_squares, king_square, pinned_pieces, satisfies_check_requirements);
		rook_legal_moves(legal_moves, queen_bb, occupied_squares, current_sides_occupied_squares, king_square, pinned_pieces, satisfies_check_requirements);
	}
...
namespace engine
{
	Fixed_capacity_vector<Move, max_legal_moves> legal_moves(const State& state) noexcept
	{
		...
		pawn_legal_moves(legal_moves, pieces[Piece::pawn], occupied_squares, state.side_to_move, our_occupied_squares, state.en_passant_target_square, king_square, pinned_pieces, satisfies_check_requirements);
		knight_legal_moves(legal_moves, pieces[Piece::knight] & ~pinned_pieces, our_occupied_squares, satisfies_check_requirements);

		bishop_legal_moves(legal_moves, pieces[Piece::bishop], occupied_squares, our_occupied_squares, king_square, pinned_pieces, satisfies_check_requirements);
		rook_legal_moves(legal_moves, pieces[Piece::rook], occupied_squares, our_occupied_squares, king_square,  pinned_pieces, satisfies_check_requirements);
		queen_legal_moves(legal_moves, pieces[Piece::queen], occupied_squares, our_occupied_squares, king_square, pinned_pieces, satisfies_check_requirements);
		return legal_moves;
	}
	...
	Fixed_capacity_vector<Move, max_legal_moves>  noisy_moves(const State& state) noexcept
	{
		// inefficient but that is okay also does not find checking moves
		Fixed_capacity_vector<Move, max_legal_moves> moves = legal_moves(state);
		moves.erase_if([&state](const Move& move)
		{
